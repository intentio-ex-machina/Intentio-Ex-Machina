 ...
 *
 * This is a derivative work of work copyrighted by The Android Open Source
 * Project. The parent license is preserved below.
 */
...
public final class BroadcastQueue {
    ...
    private final void deliverToRegisteredReceiverLocked(BroadcastRecord r,
        ...
        if (!skip) {
            IApplicationThread callerThread = null;
            if (r.callerApp != null)
                callerThread = r.callerApp.thread;
            skip = !mService.mIntentFirewall.checkBroadcast(callerThread, r.intent, r.callingUid,
                    r.callingPid, r.resolvedType, r.resultTo, r.resultCode, r.resultData, r.resultExtras,
                    r.requiredPermission, r.appOp, r.ordered, r.sticky, filter.receiverList.uid, r.userId);
        }
    ...
    final void processNextBroadcast(boolean fromMsg) {
        synchronized(mService) {
            ...
            if (!skip) {
                ...
                skip = !mService.mIntentFirewall.checkBroadcast(callerThread, r.intent, r.callingUid,
                    r.callingPid, r.resolvedType, r.resultTo, r.resultCode, r.resultData, r.resultExtras,
                    r.requiredPermission, r.appOp, r.ordered, r.sticky, info.activityInfo.applicationInfo.uid, r.userId);
            }
